...
'true_track','vertical_rate','sensors','geo_altitude','squawk','spi','position_source']
    ...
    doc.add_periodic_callback(update, 500) #5000 ms/10000 ms for registered user . 
...
server = Server(apps, port=5006) #define an unused port
server.start()
print('Opening Bokeh application on http://localhost:5006/')
#https://docs.bokeh.org/en/test/docs/user_guide/server.html
